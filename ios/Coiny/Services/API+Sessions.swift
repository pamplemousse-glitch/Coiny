...
// `request` and touch nothing private, so they move cleanly. signInWithApple
// deliberately stays in API.swift, because it writes sessionStore and
// sessionToken, and private members are invisible to an extension in another
// file.
