...
|---|---|---|---|
| Cardano (ADA) | Blockfrost | Low | 50k req/day free — **[ACTION]** `blockfrost.io` signup |
| TON | TonCenter | Low | Free — **[ACTION]** DM `@tonapibot` on Telegram |
| Polkadot (DOT), NEAR, Aptos, Sui, Hedera | Various public RPC | Low | All free, no auth |
...
| Home value AVM | RentCast | Low | 50 free calls/month — **[ACTION]** `rentcast.io/api` |
| Vehicle market price | MarketCheck | Low | 500 free calls/month — **[ACTION]** `marketcheck.com` |
| Precious metals (gold, silver, platinum) | GoldAPI.io | Low | Free tier — **[ACTION]** `goldapi.io` |
...
| SnapTrade — catch-all (Fidelity, Vanguard, Schwab, M1, etc.) | SnapTrade | Medium | `dashboard.snaptrade.com/signup` |
| YNAB (budgeting users) | YNAB API | Low | `api.ynab.com` — free developer account |
...
| Trading cards (Pokémon, MTG, Yu-Gi-Oh) | TCGPlayer API | Low | `developer.tcgplayer.com` — `coiny-tcgplayer-api-key` |
...
| **C** | Free chain clients (BTC ✅, XRP ✅, XLM ✅, DOGE ✅, ATOM ✅) + RentCast + MarketCheck + GoldAPI | Antoine signups: RentCast, MarketCheck, GoldAPI, Blockfrost, TonCenter, Helius |
| **D** | Brokerage/retirement depth (SnapTrade, Akoya, Empower, TIAA, Coinbase consumer, Robinhood, Gemini, Kraken) | Antoine signups + form approvals |
| **E** | DeFi gaps: Hyperliquid ✅, Solana staking (Helius), Alchemy NFTs, Zerion webhooks, QuickBooks, Zerion PnL ✅ | Antoine signups |
| **F** | Long-tail: CEX Tier 2, Prosper, TCGPlayer, EIA, USDA NASS, Steam, manual buckets UI | Antoine signups |
...
| Solana | ✅ Live | Zerion |
| TRON | ✅ Live | Zerion |
| Cardano (ADA) | ⏳ Needs Blockfrost signup | Blockfrost |
| TON | ⏳ Needs Telegram bot key | TonCenter |
| Polkadot (DOT) | 🔴 Not started | Subscan |
| NEAR / Aptos / Sui / Hedera | 🔴 Not started | Various public RPC |
